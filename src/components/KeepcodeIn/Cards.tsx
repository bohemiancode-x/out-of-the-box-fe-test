...
const BASE = 'https://raw.githubusercontent.com/alinadrozdyk2/company_landingpage/main/src/assets'
...
export default function Cards({ img, heading }: CardsProps) {
  return (
      ...
      <div className="flex flex-col">
        <div>
          <div className="relative h-42 w-full mb-3">
            ...
            <img src={img} alt={heading} className="w-full object-fill rounded-2xl" />
